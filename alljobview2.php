...
include"db_con.php";
//extract($_SESSION);
$q="select jobname,company,experience,package,location,skill,skill1,skill2,skill3,description from job2";
...
<section>
  ...
  <ul class="pagination">
    <li class="page-item left-arrow"><a class="pagelink" href="alljobview.php">&#8592;</a></li>
    <li class="page-item"><a class="pagelink" href="alljobview.php">1</a></li>
    <li class="page-item two"><a class="pagelink" href="alljobview2.php">2</a></li>
   
    <li class="page-item"><a class="pagelink" href="alljobview2.php";>&#8594;</a></li>
  </ul>
</div>
</section>
